...
class Speedtest(object):
    ...
    def speedtest_thread(self):
        ...
        CTDLSpeed = str(
            round(
                (results_ct.download / 1000 / 1000 / 8),
                2)) + " M/s"
        speedtest_ct.upload()
        CTUpSpeed = str(
            round(
                (results_ct.upload / 1000 / 1000 / 8),
                2)) + " M/s"
        ...
        CUDLSpeed = str(
            round(
                (results_cu.download / 1000 / 1000 / 8),
                2)) + " M/s"
        speedtest_cu.upload()
        CUUpSpeed = str(
            round(
                (results_cu.upload / 1000 / 1000 / 8),
                2)) + " M/s"
        ...
        CMDLSpeed = str(
            round(
                (results_cm.download / 1000 / 1000 / 8),
                2)) + " M/s"
        speedtest_cm.upload()
        CMUpSpeed = str(
            round(
                (results_cm.upload / 1000 / 1000 / 8),
                2)) + " M/s"
